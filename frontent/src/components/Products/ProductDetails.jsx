...
const ProductDetails = ({ data }) => {
    ...
    const handleMessageSubmit = () => {
        navigate("/inbox?conversation=507ebjver884")
    }
                        ...
                        <div className="w-full py-5">
                            <div className="block w-full 800px:flex" >
                                <div className='w-full 800px:w-[50%]'>
                                    <img src={`${backend_url}${data && data.images[select]}`} alt="" />
                                ...
                                <div className='w-full 800px:w-[50%] pt-5'>
                                    ...
                                    <div className="flex items-center pt-8">
                                        ...
                                        <div className={`${styles.button} bg-[#6443d1] mt-4 !rounded !h-11`}
                                            ...
                                            <span className='text-white flex items-center'>
                                                Send Messsage <AiOutlineMessage className='ml-1' />
                                            </span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="w-full flex my-2">
                        ...
                        <div className="pl-2 ">
                            <div className="w-full flex items-center">
                                <h1 className="font-[500] mr-3">{"name"}</h1>
                ...
                <div className="w-full block 800px:flex p-5">
                    ...
                    <div className="w-full 800px:w-[50%] mt-5 800px:mt-0 800px:flex flex-col items-end">
                        <div className="text-left">
                            ...
                            <h5 className="font-[600] pt-3">
                                Total Reviews:{" "}
                                <span className="font-[500]">{"sdakllksa"}</span>
                            </h5>
                            <Link to="/">
                                <div
